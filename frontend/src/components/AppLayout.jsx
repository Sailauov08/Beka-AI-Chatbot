...
const navItems = [
  ...
  { to: '/pricing', label: 'Тарифтер', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z' },
        ...
        <aside className="hidden w-56 shrink-0 flex-col border-r border-surface-border bg-white md:flex">
          <div className="border-b border-surface-border px-5 py-5">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-md bg-ink text-xs font-bold text-white">
                B
              </div>
              <div>
                <span className="text-sm font-semibold tracking-tight text-surface-text">Beka AI</span>
                <p className="text-[10px] text-surface-subtext">Enterprise Chat</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-surface-border p-4">
            ...
            <p className="text-xs text-surface-subtext">{subscription?.planName || 'Тегін'}</p>
          </div>
        </aside>
      )}
